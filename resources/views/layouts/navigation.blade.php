<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700"> <!--
    ...
    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
        ...
        {{-- Adiciona um botão estilizado para a tela de índice de produtos --}}
        <a href="{{ route('produtos.index') }}"
        class="mt-4 inline-block bg--500 hover:bg--700 text-white font-bold py-2 px-4 rounded">
        Produtos
        </a>
        {{-- Adiciona um botão estilizado para a tela de índice de clientes --}}
    ...
    <x-dropdown align="right" width="48">
        ...
        <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1
